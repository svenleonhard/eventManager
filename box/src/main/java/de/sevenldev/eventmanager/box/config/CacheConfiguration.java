package de.sevenldev.eventmanager.box.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("box");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("box");
        ...
        config.getMapConfigs().put("de.sevenldev.eventmanager.box.domain.*", initializeDomainMapConfig(jHipsterProperties));
