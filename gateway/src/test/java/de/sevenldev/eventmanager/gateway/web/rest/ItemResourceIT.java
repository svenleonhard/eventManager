...
import de.sevenldev.eventmanager.gateway.repository.ItemRepository;
import de.sevenldev.eventmanager.gateway.repository.search.ItemSearchRepository;
...
public class ItemResourceIT {
    ...
    private static final String DEFAULT_MANUFACTOR = "AAAAAAAAAA";
    private static final String UPDATED_MANUFACTOR = "BBBBBBBBBB";
     ...
     *
     * @see de.sevenldev.eventmanager.gateway.repository.search.ItemSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllItems() throws Exception {
        ...
        restItemMockMvc.perform(get("/api/items?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].manufactor").value(hasItem(DEFAULT_MANUFACTOR.toString())));
    }
    ...
    public void getItem() throws Exception {
        ...
        restItemMockMvc.perform(get("/api/items/{id}", item.getId()))
            ...
            .andExpect(jsonPath("$.manufactor").value(DEFAULT_MANUFACTOR.toString()));
    }
