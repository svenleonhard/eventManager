...
import { MaterialListComponent } from 'app/entities/box/material-list/material-list.component';
...
describe('Component Tests', () => {
  describe('MaterialList Management Component', () => {
    let comp: MaterialListComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MaterialListComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.materialLists[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
