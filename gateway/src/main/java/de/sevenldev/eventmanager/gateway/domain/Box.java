...
@org.springframework.data.elasticsearch.annotations.Document(indexName = "box")
public class Box implements Serializable {
    ...
    public Box users(Set<User> users) {
        this.users = users;
        return this;
    }

    public Box addUser(User user) {
        this.users.add(user);
        return this;
    }

    public Box removeUser(User user) {
